...
## 📊 Objetivo
Este proyecto implementa técnicas de preprocesamiento de datos utilizando Python y Pandas, con control de versiones mediante Git y GitHub. El objetivo es aplicar buenas prácticas en la limpieza, transformación y normalización de datasets para proyectos de Ciencia de Datos.
